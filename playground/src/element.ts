...
async function init(): Promise<void> {
  ...
  engine.root.append([
    {
      is: 'Element2D',
      style: { width: 1600, height: 1000, transformOrigin: 'center center', transform: 'scale(0.8)' },
      children: [
        {
          is: 'Element2D',
          style: {
        ...
        },
        {
          ...
          outline: { width: 10, image: 'linear-gradient(0deg, blue, pink)', lineJoin: 'round' },
          text: 'TEXT',
        },
        {
          is: 'Element2D',
          ...
          style: {
            top: 100, left: 300, width: 300, height: 300, fontSize: 100,
            justifyContent: 'center',
            alignItems: 'center',
            textAlign: 'center',
          },
        ...
        },
        {
          is: 'Element2D',
          style: {
            top: 300, left: 100, width: 300, height: 300, fontSize: 100,
            justifyContent: 'center',
            alignItems: 'center',
            textAlign: 'center',
          },
        ...
        },
        {
          ...
          fill: {
            image: '/example.jpg',
            tile: { scaleX: 0.25, scaleY: 0.25, translateX: 0.25, translateY: 0.25 },
          },
        },
        {
          is: 'Element2D',
