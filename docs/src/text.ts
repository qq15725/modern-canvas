...
async function init(): Promise<void> {
  ...
  await fonts.load({ family: 'SJkongdie', src: 'https://bige.cdn.bcebos.com/files/202012/Ltet92xp_e7Bn.woff' })
  ...
  engine.root.append([
    new Element2D({
      ...
      id: '4zBL5IyWR9',
      style: {
        width: 493.6128236744759,
        height: 84.04438964241676,
        left: 76.05598425196851,
        top: 133.48448818897634,
        padding: 0,
        ...
        fontSize: 35,
        fontFamily: 'SJkongdie,SJkongdie-Regular',
      },
      text: {
        content: [
          {
