...
function mapToEllipse({ x, y }: { x: number, y: number }, rx: number, ry: number, cosPhi: number, sinPhi: number, centerX: number, centerY: number, out: { x: number, y: number }): { x: number, y: number } {
  x *= rx
  y *= ry
